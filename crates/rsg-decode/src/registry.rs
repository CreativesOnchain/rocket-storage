...
pub const SATURN1_NEW_CONTRACTS: &[(&str, &str)] = &[
    ...
    (
        "rocketMegapoolProxy",
        "0x1b389d76a04d01026c5f5b0a125d4ccf26f9cd51",
    ),
    (
        "rocketMegapoolManager",
        "0xf2ccd522ba5ffeda28fe0389963845d61f342034",
    ),
    (
        "linkedListStorage",
        "0x52590e8aac140e2020f8f51695719922ebccb6d6",
    ),
    (
        "rocketDAOProtocolSettingsMegapool",
        "0x40628faac22383327b9f7bbc86cd1857050a2dce",
    ),
    (
        "rocketDAOSecurityUpgrade",
        "0x950baf0358164339114914169bf16754789b5dc4",
    ),
    (
        "rocketNetworkRevenues",
        "0x9d9708da8e0200dd8dd9ad09e0aaf184ad260842",
    ),
    (
        "beaconStateVerifier",
        "0xe9a114c50f26001443b91079ab5573a90d2d8469",
    ),
    (
        "rocketMegapoolPenalties",
        "0xa2afc3c2d8ea4ebdbe925cade17c29517630e6ab",
    ),
    (
        "rocketNetworkSnapshotsTime",
        "0x569f5b3024054ab4049a50df223a747afe18a891",
    ),
    (
        "rocketNodeManager",
    ...
    (
        "rocketNodeDeposit",
        "0x6b13698c306a297fee1383cdc2c65d63781d2d47",
    ),
    (
        "rocketNodeStaking",
        "0xedfc7dcae43ff954577a2875a9d805874490ee3e",
    ),
    (
        "rocketDepositPool",
    ...
    (
        "rocketDAOProtocol",
        "0xcac25e88276a333cf9d4196d112d93af67ef809a",
    ),
    (
        "rocketDAOProtocolProposals",
        "0xcf7f6e23cd8189b7f56b14f66e11241c8ac0f03b",
    ),
    (
        "rocketDAOProtocolSettingsNode",
        "0xb02b883303e658ddcd58d3871dc4ca0c91f0fc9d",
    ),
    (
        "rocketDAOProtocolSettingsDeposit",
        "0x227be8dd01df8ad9bed0178e4f8cec2996c5c365",
    ),
    (
        "rocketDAOProtocolSettingsNetwork",
        "0x67fd03a5095197d1ad1f932bc55e022c420b1153",
    ),
    (
        "rocketDAOProtocolSettingsSecurity",
        "0xc9d771aaf504f33bb3c8a7e67ea9f1881f837cff",
    ),
    (
        "rocketDAOProtocolSettingsMinipool",
        "0xaef94c3650aa13d7a2456477fc374a16b94b9152",
    ),
    (
        "rocketDAOSecurityProposals",
        "0x334b9b1a6f9d7531efb13746482ff40f1c2a0c4e",
    ),
    (
        "rocketDAONodeTrustedUpgrade",
        "0x9290aa076a2f1418a4e414e3d83ae03ca8e1ad10",
    ),
    (
        "rocketNetworkBalances",
        "0x1d9f14c6bfd8358b589964bad8665add248e9473",
    ),
    (
        "rocketNetworkSnapshots",
        "0xe37f2d9dfb7397caf671df5190a5dfb601028f17",
    ),
    (
        "rocketNetworkPenalties",
        "0xed0493de30e82be7c16c8925c7204ce9d1136b3a",
    ),
    (
        "rocketRewardsPool",
        "0xcba5951fc706fc783b7c142dae8576ebe29c41fd",
    ),
    (
        "rocketNodeDistributorDelegate",
        "0x35a85d4c115801395e6e3abaa784fb05826f129d",
    ),
    (
        "rocketClaimDAO",
        "0xfb2f2ab63dcf412ced6cde5f4f809215ed0c81aa",
    ),
    (
        "rocketMinipoolBondReducer",
        "0xde8ab526b19fca2d5a57c4a78b698041717be591",
    ),
    (
        "rocketMinipoolManager",
        "0xe54b8c641fd96de5d6747f47c19964c6b824d62c",
    ),
    (
        "rocketNetworkVoting",
        "0x994a9c49230fec0c127b8f42d6c5288f02610aed",
    ),
    (
        "rocketMerkleDistributorMainnet",
        "0xe4e2612ee8d7fdc8518faea85770a3b9c886e2f5",
    ),
    (
        "rocketDAOProtocolSettingsProposals",
        "0xf6ad771dfb1cd10c66f688e251b5e5c21cbfdf81",
    ),
];
...
pub const SATURN1_OLD_CONTRACTS: &[(&str, &str)] = &[
    ...
    (
        "rocketDAOProtocol",
        "0x1b714ed0ce30a8bedc5b4253daaa08c84ca5bfcb",
    ),
    (
        "rocketDAOProtocolProposals",
        "0x6d736da1dc2562dbea9998385a0a27d8c2b2793e",
    ),
    (
        "rocketDAOProtocolSettingsNode",
        "0x448da008c7eb2501165c9aa62dffeec4405bc660",
    ),
    (
        "rocketDAOProtocolSettingsDeposit",
    ...
    (
        "rocketDAOProtocolSettingsNetwork",
        "0x89682e5f9bf69c909fc5e21a06495ac35e3671ab",
    ),
    (
        "rocketDAOProtocolSettingsSecurity",
        "0x1ec364cdd9697f56b8cb17a745b98c2b862cbe29",
    ),
    (
        "rocketDAOProtocolSettingsMinipool",
        "0xa416a7a07925d60f794e20532bc730749611a220",
    ),
    (
        "rocketDAOSecurityProposals",
        "0x6004fa90a27db9971add200d1a3bb34444db9fb7",
    ),
    (
        "rocketDAONodeTrustedUpgrade",
        "0x952999ec97248547d810fd6464fdb78855b022ab",
    ),
    (
        "rocketNetworkBalances",
    ...
    (
        "rocketNetworkSnapshots",
        "0x7603352f1c4752ac07aac94e48632b65fdf1d35c",
    ),
    (
        "rocketNetworkPenalties",
        "0x9294fc6f03c64cc217f5be8697ea3ed2de77e2f8",
    ),
    (
        "rocketRewardsPool",
    ...
    (
        "rocketClaimDAO",
        "0xfe6db0ce3f61a4ae04c0a3e62f775a6f511c9aac",
    ),
    (
        "rocketMinipoolBondReducer",
        "0xf7ab34c74c02407ed653ac9128731947187575c0",
    ),
    (
        "rocketMinipoolManager",
    ...
    (
        "rocketNetworkVoting",
        "0x77cf0f32bdd06242465eb3318a81196194a13daa",
    ),
    (
        "rocketMerkleDistributorMainnet",
    ...
    (
        "rocketDAOProtocolSettingsProposals",
        "0x59cd103df1be2ebd80d45c54a3cde8d4f812c034",
    ),
];
...
pub fn is_security_allowed_setting(namespace: &str, setting: &str) -> bool {
    SECURITY_ALLOWED_SETTINGS
        .iter()
        .any(|(ns, s)| *ns == namespace && *s == setting)
}
...
pub fn is_protocol_setting(namespace: &str, setting: &str) -> bool {
    PROTOCOL_SETTINGS
        .iter()
        .any(|(ns, settings)| *ns == namespace && settings.contains(&setting))
}
...
mod tests {
    ...
    fn test_saturn1_new_contracts_have_valid_20_byte_addresses() {
        for (name, addr_str) in SATURN1_NEW_CONTRACTS {
            ...
            assert!(
                parsed.is_ok(),
                "invalid address for new contract {name}: {addr_str}"
            );
        }
    }
    ...
    fn test_saturn1_old_contracts_have_valid_20_byte_addresses() {
        for (name, addr_str) in SATURN1_OLD_CONTRACTS {
            ...
            assert!(
                parsed.is_ok(),
                "invalid address for old contract {name}: {addr_str}"
            );
        }
    }
    ...
    fn test_no_duplicate_contract_names_in_registries() {
        ...
        for (name, _) in SATURN1_NEW_CONTRACTS {
            assert!(
                ...
                "duplicate in SATURN1_NEW_CONTRACTS: {name}"
            );
        }
        ...
        for (name, _) in SATURN1_OLD_CONTRACTS {
            assert!(
                ...
                "duplicate in SATURN1_OLD_CONTRACTS: {name}"
            );
        }
        ...
        for name in ALL_CONTRACT_NAMES {
            assert!(
                ...
                "duplicate in ALL_CONTRACT_NAMES: {name}"
            );
        }
    }
    ...
    fn test_registry_lookup_helpers() {
        ...
        assert!(is_security_allowed_setting(
            "network",
